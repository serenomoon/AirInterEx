        ...
        <div>
            ...
            <div className='flightinfo-list'>
                ...
                <div>
                    ...
                    <Link to=''>View downloadable maps & connection guides</Link>
                </div>

                <div>
                    <h5>Customer service & tarmac delay plan</h5>
                    <p>Air New Zealand's guiding principle drives us to "be the customers' airline of choice when travelling to, from and within New Zealand."</p>
                    <Link to=''>See more of our customer service plan</Link>
                </div>
            </div>
        </div>
